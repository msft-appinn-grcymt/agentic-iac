...
var appSeviceCount = last(name)

//Define name for the parent resource - App Service plan
var appServicePlanName = '${minName}-${rgName}-ASP0${appSeviceCount}'
...
module privateendpoointapp '../Networking/privateEndpoint.module.bicep' = {
